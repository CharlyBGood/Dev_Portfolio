...
const projects: Project[] = [
  {
    ...
    title: 'NoStateNode',
    description: 'WebApp en modo -Lista de Recursos- para compartir entre contactos. Autenticación con Google y almacenamiento de recursos en Firebase/Firestore.',    
    url: 'https://nostatenode.site/',
    tags: ["React", "CSS", "Firebase/Firestore", "Google Auth/OAuth", "Vercel"],
  },
  {
    id: 2,
    image: 'https://res.cloudinary.com/dr8pwzxzn/image/upload/v1750881465/902fae94-b60e-4761-916b-780ffd735b3a.png', 
